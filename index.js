...
// === الإعدادات ===
// ضع هنا IDs الرولات الخاصة بك
const MANAGER_ROLE_ID = "ضع_هنا_ID_رول_الإدارة";   
const BLACKLIST_ROLE_ID = "ضع_هنا_ID_رول_البلاك_ليست"; 
const SERVER_LOGO_URL = "ضع_هنا_رابط_صورة_السيرفر";  
